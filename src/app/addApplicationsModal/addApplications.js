 ...
 * dependency.It is not the same as the $modal service
 *
 * ngtype: controller
 *
...
angular.module('ozpWebtop.addApplications', []);

angular.module('ozpWebtop.addApplications').controller('AddAppsCtrl', function($scope) {
  $scope.test = true;
});
